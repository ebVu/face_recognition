...
if __name__ == '__main__':
    file_dir='/media/sf_E_DRIVE/camera project/tf-insightface/tools/test_tool/ben_afflek'
    output_path='/media/sf_E_DRIVE/camera project/tf-insightface/tools/test_tool/output'
    Data_augmentation.main(file_dir,output_path)